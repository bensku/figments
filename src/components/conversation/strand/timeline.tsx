...
/**
 * Card component for displaying an alternative sibling node.
...
function AlternativeCard({
    ...
    sibling: Row<typeof NodeTable>;
    onClick: () => void;
}) {
    const persona = usePersona(sibling.author);
    const isUser = sibling.role === 'user';
    const hue = isUser ? 220 : hashStringToHue(sibling.author || 'default');
